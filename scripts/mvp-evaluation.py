#!/usr/bin/env python3
"""Dedicated, serial entrypoint for the frozen MVP evaluation v11 contract."""
import argparse
...
SOURCES = {
    ...
    'local-skills/mvp-mediator-architecture/SKILL.md': '32126db46011ee957fe8cc10ec63d8a93c856a3811ea3bbf1be662bb7d8bad1a',
