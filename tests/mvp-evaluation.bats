...
@test "MVP v12 distributes the reporting example and retains the v10 E checker" {
...
assert 'docs/evaluations/mvp-mediator-evaluation-v12/protocol.md' in start['sources']
PYTEST
}
...
for version in ('v2','v3','v4','v5','v6','v7','v8','v9','v10','v11','v12'):
