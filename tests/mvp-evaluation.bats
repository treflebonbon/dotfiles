...
@test "MVP v16 distributes the proposal state table contract and retains the v10 E checker" {
...
assert 'docs/evaluations/mvp-mediator-evaluation-v16/protocol.md' in start['sources']
PYTEST
}

@test "MVP reporting example distinguishes checked state and effects" {
  run node --test "$ROOT/tests/mvp-reporting-example.mjs"
...
for version in ('v2','v3','v4','v5','v6','v7','v8','v9','v10','v11','v12','v13','v14','v15','v16'):
