...
- Offer `Reword` for sections that should stay but whose wording should match Opus 5 prompting best practices (see `references/criteria.md` §7 and its cited sources).
